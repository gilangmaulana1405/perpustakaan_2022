   <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
          <a class="logo mr-auto" href="/main-page/home"><img src="{{ asset('img/logo.png') }}" alt=""></a>
          <!-- Navbar -->
          <nav id="navbar" class="navbar">
             <ul>
              ...
              <li><a class="nav-link scrollto {{ Request::is('main-page/tutorial') ? 'active' : '' }}" href="/main-page/tutorial">How To Use</a></li>
